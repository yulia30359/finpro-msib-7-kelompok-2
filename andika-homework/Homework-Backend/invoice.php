...
<body>
    <nav class="navbar">
        <div class="nav-brand">
            <img class="logo" src="./img/WatcXXIng.png" alt="Logo-Eternals">
        </div>
        <div class="location">
    ...
    <div class="main-content-invoice">
        <div class="information-page">Pesanan Berhasil! Scan QR Code di bawah Ini Untuk Mencetak E-Tiket di Kasir.</div>
        <div class="card-ticket">
            <img class="QR" src="img/Q.png" alt="QR Code">
