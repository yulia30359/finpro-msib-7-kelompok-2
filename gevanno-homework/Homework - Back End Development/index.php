...
<head>
    ...
    <title>Cinema24</title>
    <link rel="stylesheet" href="./css/styles.css">
    <link rel="stylesheet" href="./css/styles-laptop-small.css">
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card-thumbnail">
            <img class="thumbnail" src="./image/thumbnail.png" alt="thumbnail">
            <div class="body-card-thumbnail">
                <div class="title">Interstellar</div>
                <div class="bottom-side">
                    <div class="rating"><i class="fa-solid fa-star" style="font-size: 18px; color: #FFCD29; padding-right: 5px;"></i>9.9</div>
                    <div class="tahun">2014</div>
        ...
        <div class="detail-order">
            <form action="invoice.php" method="POST">
                <div class="header">Ticket Type:</div>
                <div class="ticket-type">
                    <div class="card-ticket-type">
                        <!-- Adult Tickets -->
                        <div class="max-w-xs mx-auto">
                            <label for="ticket_adult" class="title-ticket-type">Adult Tickets:</label>
                    ...
                    <div class="card-ticket-type">
                        <!-- Child Tickets -->
                        <div class="max-w-xs mx-auto">
                            <label for="ticket_child" class="title-ticket-type">Child Tickets:</label>
                            <div class="relative flex items-center max-w-[8rem]">
                                <!-- Tombol Decrement -->
                ...
                <div class="time-container">
                    <div class="time-card" onclick="selectTime(this)">12:00</div>
    ...
    <div id="confirmation-modal" class="hidden fixed z-50 inset-0 overflow-y-auto">
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="modal-content bg-white rounded-lg shadow-lg p-6 max-w-md w-full relative z-10">
                <h2 class="headline-modal font-bold mb-4">Are you sure?</h2>
                ...
                <div class="flex justify-center mt-6">
                    ...
                    <button id="confirm-checkout" class="confirm-button text-black rounded-lg w-full py-2 ml-2">Order Now</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="warning-modal" class="hidden fixed z-50 inset-0 overflow-y-auto">
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="modal-content bg-white rounded-lg shadow-lg p-6 max-w-md w-full relative z-10">
                ...
                <p class="message-modal mb-4">Semua bagian harus terisi<br>untuk melanjutkan proses selanjutnya!</p>
                <div class="flex justify-center mt-6">
